...
import com.pixelrp.core.mechanic.townMechanic.commands.TownHelpCommand;
...
public class ResourceHelpCommand implements CommandExecutor {
    ...
    public static CommandSpec createSpec() {
        ...
        CommandSpec spec = CommandSpec.builder()
                .executor(new ResourceHelpCommand())
                .arguments()
    ...
    private Text createHelpMsg(CommandSource src, String label, CommandCallable callable) {
        return Text.of(TextColors.GOLD, "/resource ", label, " ", callable.getUsage(src));
    }

    @Override
    public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
        src.sendMessage(Text.of(TextColors.YELLOW, "=============== Resource Help ==============="));
